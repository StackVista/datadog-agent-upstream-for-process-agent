...
require (
	...
	github.com/DataDog/datadog-agent/pkg/gohai v0.49.0-rc.7
	...
	github.com/DataDog/datadog-agent/pkg/security/secl v0.49.0-rc.7
	github.com/DataDog/datadog-agent/pkg/trace v0.49.0-rc.7
...
require (
	...
	github.com/DataDog/datadog-agent/pkg/networkdevice/profile v0.49.0-rc.7
