...
require (
	...
	github.com/DataDog/datadog-agent/pkg/gohai v0.49.0
	github.com/DataDog/datadog-agent/pkg/obfuscate v0.49.0
	github.com/DataDog/datadog-agent/pkg/remoteconfig/state v0.49.0
	github.com/DataDog/datadog-agent/pkg/security/secl v0.49.0
	github.com/DataDog/datadog-agent/pkg/trace v0.49.0
...
require (
	...
	github.com/DataDog/datadog-agent/pkg/networkdevice/profile v0.49.0
