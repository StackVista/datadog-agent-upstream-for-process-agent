...
require (
	...
	github.com/DataDog/datadog-agent/pkg/gohai v0.62.2
	...
	github.com/DataDog/watermarkpodautoscaler v0.10.0-tracing.6
...
require (
	github.com/DataDog/datadog-agent/comp/api/authtoken v0.62.2
	...
	github.com/DataDog/datadog-agent/comp/otelcol/ddflareextension/impl v0.62.2
...
require (
	...
	github.com/DataDog/datadog-agent/comp/core/log/impl v0.62.2
	github.com/DataDog/datadog-agent/comp/core/log/impl-trace v0.62.2
	...
	github.com/DataDog/datadog-agent/comp/core/status/statusimpl v0.62.2
	...
	github.com/DataDog/datadog-agent/comp/otelcol/collector-contrib/impl v0.62.2
	...
	github.com/DataDog/datadog-agent/pkg/logs/util/testutils v0.62.2
	github.com/DataDog/datadog-agent/pkg/metrics v0.62.2
	github.com/DataDog/datadog-agent/pkg/networkdevice/profile v0.62.2
	github.com/DataDog/datadog-agent/pkg/orchestrator/model v0.62.2
	github.com/DataDog/datadog-agent/pkg/process/util/api v0.62.2
	github.com/DataDog/datadog-agent/pkg/proto v0.62.2
	github.com/DataDog/datadog-agent/pkg/security/seclwin v0.62.2
	...
	github.com/DataDog/datadog-agent/pkg/util/common v0.62.2
	github.com/DataDog/datadog-agent/pkg/util/containers/image v0.62.2
...
require (
	...
	github.com/DataDog/watermarkpodautoscaler/apis v0.0.0-20250317135325-898678857e83 // indirect
...
// we use our own fork of netlink, because we have some patches in it.
