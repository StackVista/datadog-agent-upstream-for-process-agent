...
type Telemetry struct {
	...
	dropped              *libtelemetry.Counter // this happens when PostgresStatKeeper reaches capacity
	transactionsObserved *libtelemetry.Counter
}

func NewTelemetry() *Telemetry {
	metricGroup := libtelemetry.NewMetricGroup("usm.postgre", libtelemetry.OptStatsd)
