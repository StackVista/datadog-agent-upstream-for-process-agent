...
func (s *HTTPTestSuite) TestHTTPMonitorInstructionCounts() {
	...
	instrCounts := map[string]int{
		"istio_uretprobe__SSL_read":                                4917,
		"istio_uretprobe__SSL_write":                               4836,
		"kprobe__sockfd_lookup_light":                              22,
		"kprobe__tcp_close":                                        776,
		"kprobe__tcp_sendmsg":                                      593,
		"kretprobe__sockfd_lookup_light":                           651,
		"nodejs_uretprobe__SSL_read":                               4917,
		...
		"socket__kafka_fetch_response_record_batch_parser_v12":     4583,
		"socket__kafka_filter":                                     13308,
		"socket__kafka_produce_response_partition_parser_v0":       1888,
		"socket__kafka_produce_response_partition_parser_v9":       1626,
		"socket__mongo_filter":                                     383,
		"socket__postgres_handle":                                  3016,
		"socket__protocol_dispatcher":                              17073,
		"socket__protocol_dispatcher_kafka":                        19406,
		"socket__redis_process":                                    2,
		"tracepoint__net__netif_receive_skb":                       2237,
		...
		"uprobe__http2_dynamic_table_cleaner":                      3962,
		"uprobe__http2_tls_eos_parser":                             128955,
		"uprobe__http2_tls_filter":                                 67859,
		...
		"uprobe__kafka_tls_fetch_response_record_batch_parser_v12": 4288,
		"uprobe__kafka_tls_filter":                                 6566,
		"uprobe__kafka_tls_produce_response_partition_parser_v0":   1189,
		"uprobe__kafka_tls_produce_response_partition_parser_v9":   1293,
		"uprobe__kafka_tls_termination":                            41,
		"uprobe__mongo_process":                                    414,
		"uprobe__postgres_tls_handle":                              2751,
		"uprobe__postgres_tls_termination":                         105,
		"uprobe__redis_tls_process":                                2,
		"uprobe__redis_tls_termination":                            2,
		"uprobe__tls_protocol_dispatcher_kafka":                    33337,
		"uretprobe__BIO_new_socket":                                29,
		"uretprobe__SSL_connect":                                   9,
		"uretprobe__SSL_do_handshake":                              9,
		"uretprobe__SSL_read":                                      4917,
		"uretprobe__SSL_read_ex":                                   4832,
		"uretprobe__SSL_write":                                     4836,
		"uretprobe__SSL_write_ex":                                  4807,
		"uretprobe__gnutls_handshake":                              9,
		"uretprobe__gnutls_record_recv":                            4910,
		"uretprobe__gnutls_record_send":                            4829,
	}
