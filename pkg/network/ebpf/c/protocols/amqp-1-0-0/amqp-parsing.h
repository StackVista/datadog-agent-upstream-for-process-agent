...
static __always_inline int amqp_1_0_0_process(conn_tuple_t *tup, const bpf_buffer_desc_t *buf) {
    ...
    while (number_of_frames_processed < 200) {
        ...
        if (list_identifier == 0xd0) {
            ...
            argument_size = bpf_ntohl(arguments.size);
        ...
        {
        case 2:
            delivery_count = *delivery_count_8;
            break;
        case 3:
            delivery_count = bpf_ntohs(*delivery_count_16);
            break;
        case 5:
            delivery_count = bpf_ntohl(*delivery_count_32);
            break;
        default:
            break;
        }
