...
// We use this method to understand at runtime the offset of skb inside the ctx. We use a constant loaded from userspace.
// See https://gitlab.com/stackvista/agent/datadog-agent-upstream-for-process-agent/-/merge_requests/29
